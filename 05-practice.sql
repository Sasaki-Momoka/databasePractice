...
FROM celebrities
WHERE < (
    SELECT AVG(age) FROM celebrities
)
...
SELECT name FROM country WHERE independence_date IS NULL;


-- 問8
-- 独立独立記念日がある国をすべて抽出してください。
SELECT name FROM country WHERE independence_date IS NOT NULL;


-- 問9
-- 名前の末尾が「ia」で終わる国を抽出してください。
SELECT name FROM country WHERE RIGHT(name, 2) = 'ia';
