...
SELECT name FROM countries WHERE RIGHT(name, 2) = 'ia';
...
SELECT name FROM countries WHERE LEFT(name, 2) = 'An';
...
SELECT c.name AS 国名 , ce.name AS 有名人
FROM countries c
LEFT OUTER JOIN celebrities ce
